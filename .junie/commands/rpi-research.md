...
Research and document codebase for a specific topic using parallel sub-agents
...
**YOU MUST use the subrecipes (rpi-codebase-locator, rpi-codebase-analyzer, rpi-pattern-finder) - they are your sub-agents.**
...
**EXECUTE THE RESEARCH WORKFLOW NOW.**
  ...
  **I will now follow the mandatory steps:**
  ...
  3. **Spawn parallel subrecipes** (rpi-codebase-locator, rpi-codebase-analyzer, rpi-pattern-finder)
...
- **rpi-codebase-locator**: Find WHERE files and components live
- **rpi-codebase-analyzer**: Understand HOW specific code works
- **rpi-pattern-finder**: Find examples of existing patterns
